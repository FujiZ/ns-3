...
public:
  ...
  /**
   * TracedCallback signature for socket events
   *
   * \param [in] socket The related socket
   */
...
private:
  ...
  /// Traced Callback: connect socket
  TracedCallback<Ptr<Socket> > m_socketConnectTrace;
  /// Traced Callback: close socket
