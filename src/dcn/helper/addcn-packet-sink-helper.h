 ...
 */
#ifndef ADDCN_PACKET_SINK_HELPER_H
#define ADDCN_PACKET_SINK_HELPER_H
 ...
 * on a set of nodes.
 */
class AddcnPacketSinkHelper
{
public:
  /**
   * Create a AddcnPacketSinkHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  AddcnPacketSinkHelper (std::string protocol, Address address);
