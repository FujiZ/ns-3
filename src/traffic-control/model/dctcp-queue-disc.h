 ...
 */
class DctcpFastQueueDisc : public QueueDisc {
public:
  /**
  ...
  /**
   * \brief DctcpFastQueueDisc constructor
   *
...
private:
  ...
  uint32_t m_k;    //!< Threshold value above which packets will be marked
};
