...
#ifndef ADDCN_BULK_SEND_HELPER_H
#define ADDCN_BULK_SEND_HELPER_H
 ...
 * on a set of nodes.
 */
class AddcnBulkSendHelper
{
public:
  /**
   * Create an AddcnBulkSendHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  AddcnBulkSendHelper (std::string protocol, Address address);
