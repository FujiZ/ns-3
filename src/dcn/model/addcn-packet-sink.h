...
#ifndef ADDCN_PACKET_SINK_H
#define ADDCN_PACKET_SINK_H
 ...
 * \defgroup packetsink AddcnPacketSink
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a AddcnPacketSink name was selected.  Functionally it is
 ...
 */
class AddcnPacketSink : public Application 
{
public:
  /**
