...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("ADDCNExample", LOG_LEVEL_INFO);
  LogComponentEnable ("ADDCNL3_5Protocol", LOG_LEVEL_INFO);
  LogComponentEnable ("ADDCNSlice", LOG_LEVEL_INFO);
  LogComponentEnable ("ADDCNFlow", LOG_LEVEL_INFO);
