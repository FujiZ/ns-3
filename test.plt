...
set output "test.png"
plot "throughput-0.txt" using 1:2 w lp title "Node 0", "throughput-1.txt" using 1:2 w lp title "Node 1", "throughput-2.txt" using 1:2 w lp title "Node 2", "throughput-3.txt" using 1:2 w lp title "Node 3"
